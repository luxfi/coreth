...
go build -ldflags "-X github.com/luxdefi/coreth/plugin/evm.GitCommit=$coreth_commit -X github.com/luxdefi/coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
