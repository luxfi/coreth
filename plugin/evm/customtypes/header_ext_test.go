...
func TestHeaderRLP(t *testing.T) {
	...
	// Golden data for header RLP encoding. This includes all standard geth header fields
	// plus Lux-specific fields (ExtDataHash, ExtDataGasUsed, BlockGasCost) and EIP-7685 RequestsHash.
	// WARNING: changing these values can break backwards compatibility with extreme consequences
	// as block-hash calculation may break.
	const (
		wantHex     = ""
		wantHashHex = "b880a47b98912ceb376e7f0ff270c06d657fce77ca0b745e09a8f3bdf07558b7"
	)
...
func headerWithNonZeroFields() (*Header, *HeaderExtra) {
	header := &Header{
		...
		Nonce:            BlockNonce{15},
		ExtDataHash:      common.Hash{21}, // Lux-specific field
		BaseFee:          big.NewInt(16),
		ExtDataGasUsed:   big.NewInt(22), // Lux-specific field
		BlockGasCost:     big.NewInt(23), // Lux-specific field
