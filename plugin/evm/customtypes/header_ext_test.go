...
func TestHeaderRLP(t *testing.T) {
	...
	// plus the RequestsHash field (EIP-7685). WARNING: changing these values can break
	// backwards compatibility with extreme consequences as block-hash calculation may break.
	const (
		wantHex     = ""
		wantHashHex = "cc59d957ae32b9de9cf39913a49a6fd5c6fed92a4edd12f6a92ee9644e8990b9"
	)
