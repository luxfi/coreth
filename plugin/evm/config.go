...
type Config struct {
	...
	ImportChainData string `json:"import-chain-data"` // Path to import blockchain data from another chain
	DatabaseBackend string `json:"database-backend"` // Database backend to use: "pebbledb" (default) or "leveldb"
