...
import (
	...
	gethmath "github.com/luxfi/math"
)
...
// In coreth, luxd prevents API calls unless bootstrapping is complete,
...
func (s *PersonalAccountAPI) UnlockAccount(ctx context.Context, addr common.Address, password string, duration *uint64) (bool, error) {
	...
	// it is disabled.
	if s.b.ExtRPCEnabled() && !s.b.InsecureUnlockAllowed() {
...
func (s *PersonalAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	...
	// crypto.PubkeyToAddress returns crypto/common.Address, convert to geth/common.Address
...
func (api *BlockChainAPI) GetProof(ctx context.Context, address common.Address, storageKeys []string, blockNrOrHash rpc.BlockNumberOrHash) (*AccountResult, error) {
	err := api.stateQueryBlockNumberAllowed(blockNrOrHash)
	if err != nil {
