...
For more details on Lux Warp Messaging, see the Luxd [Warp README](https://github.com/luxfi/node/blob/master/vms/platformvm/warp/README.md).
...
The actual `message` is the entire [Lux Warp Unsigned Message](https://github.com/luxfi/node/blob/master/vms/platformvm/warp/unsigned_message.go#L14) including an [AddressedCall](https://github.com/luxfi/node/tree/master/vms/platformvm/warp/payload#addressedcall). The unsigned message is emitted as the unindexed data in the log.
