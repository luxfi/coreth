...
import (
	...
	_ "github.com/luxfi/coreth/core"
)
	...
	tests := []statefulContractTest{
		{
			...
			value:                big0,
			gasInput:             params.AssetBalanceGasCost,
		...
		},
		{
			...
			input:                PackNativeAssetBalanceInput(userAddr1, assetID),
			value:                big0,
			gasInput:             params.AssetBalanceGasCost - 1,
			expectedGasRemaining: 0,
		...
		},
		{
			...
			value:                u256Hundred,
			gasInput:             params.AssetBalanceGasCost,
			expectedGasRemaining: params.AssetBalanceGasCost,
		...
		},
		{
			...
			value:                big0,
			gasInput:             params.AssetCallGasCost + params.CallNewAccountGas + 123,
		...
		},
		{
			...
			gasInput:             params.AssetCallGasCost + params.CallNewAccountGas,
			expectedGasRemaining: 0,
			expectedErr:          nil,
			expectedResult:       nil,
		...
		},
		{
			...
			gasInput:             params.AssetCallGasCost,
			expectedGasRemaining: 0,
			expectedErr:          vm.ErrInsufficientBalance,
			expectedResult:       nil,
		...
		},
		{
			...
			gasInput:             params.AssetCallGasCost,
			expectedGasRemaining: params.AssetCallGasCost,
			expectedErr:          vm.ErrInsufficientBalance,
			expectedResult:       nil,
		...
		},
		{
			...
			input:                PackNativeAssetCallInput(userAddr2, assetID, big.NewInt(50), nil),
			value:                uint256.NewInt(50),
			gasInput:             params.AssetCallGasCost - 1,
			expectedGasRemaining: 0,
			expectedErr:          vm.ErrOutOfGas,
			expectedResult:       nil,
		...
		},
		{
			...
			input:                PackNativeAssetCallInput(userAddr2, assetID, big.NewInt(50), nil),
			value:                uint256.NewInt(50),
			gasInput:             params.AssetCallGasCost + params.CallNewAccountGas - 1,
			expectedGasRemaining: 0,
			expectedErr:          vm.ErrOutOfGas,
			expectedResult:       nil,
		...
		},
		{
			...
			value:                big0,
			gasInput:             params.AssetCallGasCost + params.CallNewAccountGas,
			expectedGasRemaining: params.AssetCallGasCost + params.CallNewAccountGas,
			expectedErr:          vm.ErrExecutionReverted,
			expectedResult:       nil,
