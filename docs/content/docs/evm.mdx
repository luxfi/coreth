...
| EIP-4844 | Blob transactions | Active (Quasar Edition) |
| EIP-5656 | MCOPY | Active |
| EIP-6780 | SELFDESTRUCT limit | Active |
| EIP-7516 | BLOBBASEFEE | Active (Quasar Edition) |
...
Address: `0x0200000000000000000000000000000000000005` (canonical warp precompile)
...
```toml
[rpc_endpoints]
lux = "https://api.lux.network/v1/chain/C/rpc"
