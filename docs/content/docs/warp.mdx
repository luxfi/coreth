...
|   (0x0200000000000000000000000000000000000005)      |             |   (0x0200000000000000000000000000000000000005)      |
+--------+---------+             +--------+---------+
         |                                ^
         v                                |
+------------------+             +------------------+
...
The Warp precompile is deployed at the canonical address `0x0200000000000000000000000000000000000005`.
...
contract WarpSender {
    // Canonical warp precompile address
