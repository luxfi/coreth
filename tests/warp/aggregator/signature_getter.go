...
type SignatureGetter interface {
	...
	GetSignature(ctx context.Context, nodeID ids.NodeID, unsignedWarpMessage *warp.Message) (*bls.Signature, error)
}
...
func (s *NetworkSignatureGetter) GetSignature(ctx context.Context, nodeID ids.NodeID, unsignedWarpMessage *warp.Message) (*bls.Signature, error) {
