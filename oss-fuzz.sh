...
coverpkg="github.com/luxfi/geth/..."
...
repo=$GOPATH/src/github.com/luxfi/geth
compile_fuzzer github.com/luxfi/geth/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/luxfi/geth/common/bitutil \
...
compile_fuzzer github.com/luxfi/geth/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/luxfi/geth/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/luxfi/geth/eth/protocols/snap \
...
compile_fuzzer github.com/luxfi/geth/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/luxfi/geth/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/luxfi/geth/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/luxfi/geth/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/luxfi/geth/eth/protocols/eth \
