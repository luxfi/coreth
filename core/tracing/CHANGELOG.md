...
## [v1.14.9](https://github.com/luxfi/geth/releases/tag/v1.14.9)
...
There has been a major breaking change in the tracing interface for custom native tracers. JS and built-in tracers are not affected by this change and tracing API methods may be used as before. This overhaul has been done as part of the new live tracing feature ([#29189](https://github.com/luxfi/geth/pull/29189)). To learn more about live tracing please refer to the [docs](https://geth.ethereum.org/docs/developers/evm-tracing/live-tracing).
...
[unreleased]: https://github.com/luxfi/geth/compare/v1.14.8...master
[v1.14.0]: https://github.com/luxfi/geth/releases/tag/v1.14.0
[v1.14.3]: https://github.com/luxfi/geth/releases/tag/v1.14.3
[v1.14.4]: https://github.com/luxfi/geth/releases/tag/v1.14.4
