...
var (
	...
	// Database should only be included for non-archive, snapshot disabled tests.
...
// Database passes these tests because lastCommittedHeight always equals acceptorTip.
