...
// PrecompiledContractsPostQuantum contains the network precompiled contracts
// including all NIST post-quantum cryptography standards (FIPS 203, 204, 205)
var PrecompiledContractsPostQuantum = PrecompiledContracts{
	...
	common.BytesToAddress([]byte{0x1, 0x42}): &shake128_512{},       // SHAKE128-512
	common.BytesToAddress([]byte{0x1, 0x43}): &shake256{},           // SHAKE256 variable
	common.BytesToAddress([]byte{0x1, 0x44}): &shake256_256{},       // SHAKE256-256
	common.BytesToAddress([]byte{0x1, 0x45}): &shake256_512{},       // SHAKE256-512
	common.BytesToAddress([]byte{0x1, 0x46}): &shake256_1024{},      // SHAKE256-1024
...
var (
	...
	PrecompiledAddressesPostQuantum []common.Address
)
